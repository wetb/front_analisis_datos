...
const fourthQuestionData = fetchData('ie_matricula/')
...
const FourthQuestion = () => {
    ...
    let total = data.reduce(function (acc, obj) {
        return acc + obj.TOTAL_MATRICULA;
    }, 0);   
    ...
    return (
        <>
            ...
            <h2 className='flex items-center pt-10 pb-4 text-2xl font-semibold opacity-60 gap-x-2'>
                ...
                Colegios con mayor cantidad de estudiantes matriculados en el periodo (2018-2019)
            </h2>
            <Suspense fallback={<div>Loading...</div>}>
                ...
                <Card>
                    <Table className="mt-6">
                        <TableHead>
                            <TableRow>
                                <TableHeaderCell>COLEGIO</TableHeaderCell>
                                <TableHeaderCell className="text-right">TOTAL_MATRICULA</TableHeaderCell>
                            </TableRow>
                        </TableHead>
                            ...
                            {top10
                                .map((item) => (
                                    <TableRow key={item.id}>
                                        ...
                                        <TableCell className="text-right">{valueFormatter(item.TOTAL_MATRICULA)}</TableCell>
                                    </TableRow>
                                ))}
                        </TableBody>
                    </Table>
