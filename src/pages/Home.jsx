    ...
    return (
        <Container className='relative pt-20 pb-16 text-center lg:pt-32'>
            ...
            <h1 className='max-w-4xl mx-auto text-5xl font-medium tracking-tight font-display text-slate-900 sm:text-7xl'>
                INFORME{' '}
                <span className='relative text-green-600 whitespace-nowrap'>
                    <svg
                        aria-hidden='true'
                        viewBox='0 0 418 42'
                    ...
                    <span className='relative'>DJANGO + REACT</span>
                </span>{' '}

            </h1>
            <p className='max-w-xl mx-auto mt-6 text-lg tracking-tight text-slate-700'>
                Cada Pestaña de la vista da respuesta a una Pregunta en especifico alrededor de la educacion preescolar, básica primaria, 
                basica secundaria y media de las instituciones educativas, pertenecientes al departamento de boyacá correspondiente entre los años 2018 a 2019
            </p>
        </Container>
