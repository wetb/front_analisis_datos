...
const fifthQuestionData = fetchData('grado_matricula/')
    ...
    return (
        <>
            ...
            <h2 className='flex items-center pt-10 pb-4 text-2xl font-semibold opacity-60 gap-x-2'>
                ...
                Top 10 de los cursos con más estudiantes matriculados en el periodo 2018-2019
            </h2>
            ...
            <Grid numColsLg={6} className='gap-6 mt-6 mb-6'>
                                ...
                                <Table className="mt-1">
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableHeaderCell>TOTAL_MATRICULA</TableHeaderCell>
                                        </TableRow>
                                    </TableHead>
                                    <TableBody>
                                        {top10.map((item) => (
                                            <TableRow key={item.GRADO}>
                                                <TableCell>{item.GRADO}</TableCell>
                                                <TableCell>
                                                    <Text>{item.TOTAL_MATRICULA}</Text>
                                                </TableCell>
                                            </TableRow>
                                        ))}
                                    </TableBody>
                ...
                <Col numColSpanLg={4}>
                    <BarChartComponent
                        data={top10}
                        title='Número de matriculas por grados o cursos'
                        index='GRADO'
                        categories={["TOTAL_MATRICULA"]}
                        colors={["lime"]}
                        subtitle=''
                        width={100}
                    />
